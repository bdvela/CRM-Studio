...
|----|-------------|-----------|--------|
| HU-01 | Registrar clienta | Alta | ✅ |
| HU-02 | Buscar clientas | Alta | ✅ |
...
| HU | Descripción | Prioridad | Estado |
|----|-------------|-----------|--------|
| HU-06 | Crear y gestionar servicios | Alta | ✅ |
| HU-07 | Catálogo por categoría | Media | ✅ |
| HU-08 | Actualizar precios | Media | ✅ |
| HU-25 | Panel servicios — mejoras | Media | ✅ |

### 03 — Citas
| HU | Descripción | Prioridad | Estado |
|----|-------------|-----------|--------|
| HU-09 | Agendar cita | Alta | ✅ |
| HU-09b | Crear clienta inline desde cita | Alta | ✅ |
| HU-10 | Ver agenda día/semana | Alta | ✅ |
| HU-10b | Mejoras formulario citas | Alta | ✅ |
| HU-11 | Actualizar estado de cita | Alta | ✅ |
| HU-11b | Filtros avanzados de citas | Alta | ✅ |
| HU-11c | Selección servicios por chips | Alta | ✅ |
| HU-12 | Detectar solapamientos | Media | ✅ |
| HU-13 | Resumen de cita | Media | ✅ |
...
**Leyenda:** ✅ Implementado · ⏳ Pendiente · 🔄 En progreso
