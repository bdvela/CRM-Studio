...
export async function generateMetadata({ params }: { params: Promise<{ id: string }> }) {
  ...
  return { title: `${(client as any).name} — Clientas — Ara Zevallos Studio` };
}
...
export default async function ClienteDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <ClienteDetailClient initialClient={client as any} initialAppointments={appointments as any[]} />;
}
